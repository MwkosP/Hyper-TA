...
cutSELL = [
    ...
    # =====================================================
    {
        "type": "crossLevel",              # still "crossLevel", logic inverted via threshold
        "indicator": "macd",
...
#?-------------------------------------------------------
ALL_SEARCH_SPACES = {
    "crossLevel_buy": cutBUY,
    "crossLevel_sell": cutSELL,
    "line_buy": cultBUY,
    "line_sell": cultSELL,
    "range_buy": irtBUY,
    "range_sell": irtSELL,
